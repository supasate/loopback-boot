...
function getConfigVariable(app, param) {
...
PluginBase.prototype.getUpdatedConfigObject = function(context, config) {
  var app = context.app;

  function interpolateVariables(config) {
    // config is a string and contains a config variable ('${var}')
    if (typeof config === 'string')
      return getConfigVariable(app, config);
    ...
    Object.keys(config).forEach(function(configKey) {
      ...
      if (Array.isArray(value)) {
        ...
        interpolated[configKey] = getConfigVariable(app, value);
